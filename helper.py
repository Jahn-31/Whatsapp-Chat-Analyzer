...
def most_common_words(selected_user, df):
    ...
    most_common_df = pd.DataFrame(Counter(all_words).most_common(25))
...
def activity_heatmap(selected_user,df):
    ...
    active_heatmap = df.pivot_table(index='day_name',columns ='period', values='message', aggfunc='count').fillna(0)
